...
\includegraphics[width=0.85\textwidth,height=\textheight]{/Users/busenursarica/Documents/GitHub/rstudio/images/steve.png}
...
\includegraphics[width=0.85\textwidth,height=\textheight]{/Users/busenursarica/Documents/GitHub/rstudio/images/bill.png}
...
\includegraphics[width=0.85\textwidth,height=\textheight]{/Users/busenursarica/Documents/GitHub/rstudio/images/P1.png}

\includegraphics[width=0.85\textwidth,height=\textheight]{/Users/busenursarica/Documents/GitHub/rstudio/images/P2.png}

\includegraphics[width=0.85\textwidth,height=\textheight]{/Users/busenursarica/Documents/GitHub/rstudio/images/P3.png}

\includegraphics[width=0.85\textwidth,height=\textheight]{/Users/busenursarica/Documents/GitHub/rstudio/images/P4.png}
...
\includegraphics{/Users/busenursarica/Documents/GitHub/rstudio/images/D1.png}

Uygun işletim sistemi seçildikten sonra \texttt{install\ R\ for\ the\ first\ time} tıklanarak temel versiyon seçilmelidir.

\includegraphics{/Users/busenursarica/Documents/GitHub/rstudio/images/D2.png}
...
\includegraphics{/Users/busenursarica/Documents/GitHub/rstudio/images/D3.png}
...
\includegraphics[width=0.7\textwidth,height=\textheight]{/Users/busenursarica/Documents/GitHub/rstudio/images/00.png}

RStudio editor, görsel ve uygulama avantajları sayesinde uygulama kolaylığı sağlamaktadır.

\includegraphics{/Users/busenursarica/Documents/GitHub/rstudio/images/01.png}
...
\includegraphics{/Users/busenursarica/Documents/GitHub/rstudio/images/02.png}

\includegraphics{/Users/busenursarica/Documents/GitHub/rstudio/images/03.png}

RStudio cheatsheat yapısı sayesinde bir çok konu başlığında özet bilgiye ulaşmak mümkün.

\includegraphics{/Users/busenursarica/Documents/GitHub/rstudio/images/04.png}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{x<-}\DecValTok{1}\OperatorTok{:}\DecValTok{20}  \CommentTok{#1'den 20'ye 1'er artan seri}
\NormalTok{x}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{x<-}\KeywordTok{seq}\NormalTok{(}\DataTypeTok{from=}\DecValTok{5}\NormalTok{,}\DataTypeTok{to=}\DecValTok{20}\NormalTok{,}\DataTypeTok{by=}\DecValTok{5}\NormalTok{) }\CommentTok{#5'den 20'ye 5'er artan seri}
\NormalTok{x}
\end{Highlighting}
\end{Shaded}
