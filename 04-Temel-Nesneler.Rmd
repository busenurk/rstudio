...
Gözlemleri sıralamak için `sort()` komutu kullanılır. `sort()` kodu  default olarak küçükten büyüğe sıralama yapar, sıralama yönünü değiştirmek `decreasing` ile gerçekleştirilir.
